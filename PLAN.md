...
- [ ] **S1** Chunk-window migration · **in progress** · deps: `scale` P3 · serves: scale
  ...
  **Step 5 started (A.104):** the `Nat.mod` wrap-range bound is proven
  ...
  (`src/g7.bend`; T102–T104). **`G-scale-8` window-edge shell landed (A.106):**
  `src/winshell.bend` puts the shell at the window's own local `0`/`63` edge and
  reproduces `gen` on the canonical box (`win_gen_canonical`; T106/T107).
